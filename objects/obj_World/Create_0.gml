...
// Player macros and enums
#macro HITBOX_X1 (sprite_get_bbox_left(mask_index) - sprite_get_xoffset(mask_index))
#macro HITBOX_Y1 (sprite_get_bbox_top(mask_index) - sprite_get_yoffset(mask_index))
#macro HITBOX_X2 (sprite_get_bbox_right(mask_index) - sprite_get_xoffset(mask_index))
#macro HITBOX_Y2 (sprite_get_bbox_bottom(mask_index) - sprite_get_yoffset(mask_index))
